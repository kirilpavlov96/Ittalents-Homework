...
public class Demo {
	...
	public static void main(String[] args) {
		...
		case -1:
			System.out.println("The first PC is more expencive!");
			break;
		case 1:
			System.out.println("The second PC is more expencive!");
			break;
		case 0:
			System.out.println("Both PCs have equal prices!");
			break;
		default:
			System.out.println("There was some problem with the method!");
			break;
		}
